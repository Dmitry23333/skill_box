...
public class KafkaConfiguration {
    ...
    @Bean
    public ProducerFactory<String, Status> kafkaMessageProducerFactory(ObjectMapper objectMapper) {
    ...
    @Bean
    public KafkaTemplate<String, Status> kafkaTemplate(ProducerFactory<String, Status> kafkaMessageProducerFactory) {
    ...
    @Bean
    ConcurrentKafkaListenerContainerFactory<String, OrderEvent> kafkaMessageConcurrentKafkaListenerContainerFactory(
