...
import com.example.service.integration.configuration.properties.AppCacheProperties;
...
public class CacheConfiguration {
    @Bean
    public CacheManager redisCacheManager(AppCacheProperties appCacheProperties, LettuceConnectionFactory factory) {
