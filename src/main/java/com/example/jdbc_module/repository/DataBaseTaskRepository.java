...
import com.example.jdbc_module.repository.mapper.TaskRowMapper;
...
public class DataBaseTaskRepository implements TaskRepository {
    ...
    public Task update(Task task) {
        ...
        if (existedTask !=null){
            ...
            jdbcTemplate.update(sql,task.getTitle(), task.getDescription(), task.getDescription(), task.getId());
        }
        return task;
    }
