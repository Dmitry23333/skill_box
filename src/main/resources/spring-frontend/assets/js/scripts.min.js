        ...
        var Card = function () {
            var bookTemplate = function (bookEntity) {
                return '<div class="Card">' + '   <div class="Card-picture">' + '<a href="' + bookEntity.slug + '">' + '       <img src="' + bookEntity.image + '">\n' + '</a>' +
                    (bookEntity.discount ? '<div class="Card-sale">' + (bookEntity.discount * 100) + '% скидка</div>' : '') +
                    ...
                    (bookEntity.price ? '<span class="Card-priceOld">₽' + bookEntity.price + '</span>\n' : '') + '                       <span class="Card-price">₽' + bookEntity.discountPrice + '</span>\n' + '                </div>\n' + '              </div>\n' + '            </div>';
            }
            return {
                init: function () {
